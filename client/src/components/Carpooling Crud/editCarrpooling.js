...
export class EditCarpooling extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            doc:null,
    ...
    handleSubmit = event => {
      ...
      //  axios.post(`carpooling/car`, carpooling)
        ...
        axios.put(`http://localhost:3000/carpooling/car/`+this.props.match.params.id, carpooling)
    }
    render() {
        return (
            <div>
...

                                {
                                    this.state.isOffer ?
                                        ...
                                        <form onSubmit={this.handleSubmit} action method="post" role="form" className="contactForm">
                                            ...
                                            <div className="form-group">
                                                <textarea name="description" value={this.state.description} onChange={this.handleChange} placeholder="Your text" className="form-control" rows="5" cols="30" />
                                            </div>
                                            ...
                                            <div className="form-group">
                                                <input className="form-control" name="from" id="from" placeholder="from" data-msg="Please enter a valid email"
                                                    value={this.state.trage.from} onChange={this.handleChange} />

                                            </div>

                                            <div className="form-group">
                                                <input className="form-control" name="to" id="to" placeholder="to" data-msg="Please enter a valid email"
                                                    value={this.state.trage.to} onChange={this.handleChange} />
                                            ...
                                            <div className="form-group">
                                                <input type='number' className="form-control" name="disponibility" id="disponibility" placeholder="disponibility" data-msg="Please enter number disponibility"
                                                    value={this.state.disponibility} onChange={this.handleChange} />
